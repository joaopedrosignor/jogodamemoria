...
def inicioDoJogo():
    ...
    while pares_corretos < 8:  # Total de pares é 8
        ...
        if carta1 in cartas_descobertas:
        ...
        while (linhaSE == linhaPE and colunaSE == colunaPE) or verificarCarta(linhaSE, colunaSE - 1) in cartas_descobertas:
        ...
        if carta1 == carta2:
            ...
            print(carta1)
            pares_corretos += 1
            cartas_descobertas.add(carta1)
            cartas_descobertas.add(carta2)
        else:
